...
**          例如:    GetChinaCalendar(2007,02,06,(uint8_t *)p);p-> 2006/12/19 在BC++4.5上可仿真
**          增加了天干地支转换             ★〓个人原创〓★
**          输入公历日期得到农历字符串  
...
{
private:
    void StrCopy(char *target,uint8_t const *source,uint8_t no);
    uint8_t GetMoonDay(uint8_t month_p,unsigned short table_addr);
    void GetSkyEarth(uint16_t myear,uint8_t *p);
public:
    //uint8_t   sky[][3];
//    uint8_t   earth[][3];
//    uint8_t   monthcode[][3];
...
**------------------------------------------------------------------------------------------------------
********************************************************************************************************/
    uint8_t GetChinaCalendar( uint16_t  myear,     uint8_t mmonth,       uint8_t mday,          uint8_t *p);
/*********************************************************************************************************
** 函数名称:GetWeek
...
**------------------------------------------------------------------------------------------------------
********************************************************************************************************/
    void GetWeek( uint16_t myear,  uint8_t mmonth,  uint8_t mday,  uint8_t *p);
/*********************************************************************************************************
...
**------------------------------------------------------------------------------------------------------
********************************************************************************************************/
    void GetChinaCalendarStr(  uint16_t  myear,    uint8_t mmonth,       uint8_t mday,   String *str);
...
**------------------------------------------------------------------------------------------------------
********************************************************************************************************/
    uint8_t GetJieQiStr(      uint16_t myear,      uint8_t mmonth,      uint8_t mday,               String *str);
